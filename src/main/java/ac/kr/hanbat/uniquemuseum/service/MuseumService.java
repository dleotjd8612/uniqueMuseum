...
public interface MuseumService {
    ...
    void remove(Long mno); // 박물관 삭제
    void modify(MuseumDTO museumDTO); // 박물관 수정
    ...
    default MuseumDTO entitiesToDTO(Museum museum, List<MuseumImage> museumImages, Double avg, Long reviewCnt) {
        MuseumDTO museumDTO = MuseumDTO.builder()
                ...
                .weekdaysOpen(museum.getWeekdaysOpen().format(DateTimeFormatter.ofPattern("hh:mm")))
                .weekdaysClose(museum.getWeekdaysClose().format(DateTimeFormatter.ofPattern("hh:mm")))
                .weekendOpen(museum.getWeekendOpen().format(DateTimeFormatter.ofPattern("hh:mm")))
                .weekendClose(museum.getWeekendClose().format(DateTimeFormatter.ofPattern("hh:mm")))
